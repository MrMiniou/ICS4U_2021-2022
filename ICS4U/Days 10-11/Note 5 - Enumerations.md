...
In Java, an **enum** is like a class combined with an array. They are used for defining an ordered sequence of constant-like values and can help make programs more readable than using arrays of constants.
